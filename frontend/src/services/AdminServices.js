...
export const sendEmail = async (product) => {
  try {
    const response = await axiosInstance({
      baseURL: "http://localhost:2000/email/",
...
export const getPasswordLogin = async () => {
  try {
    const response = await axiosInstance.get(`/passwordLogin`);
    if (response.data.stat !== null) {
...
export const getPasswordAdmin = async () => {
  try {
    const response = await axiosInstance.get(`/passwordAdmin`);
    if (response.data.stat !== null) {
      return response.data.arr;
    }
    return null;
...
export const getProductsByCategoryWithoutLimit = async (category) => {
  try {
    const response = await axiosInstance.get(`/productsByCategory/${category}`);
    if (response.data.stat !== null) {
      return response.data.arr;
    }
    return null;
...
export const getProductsNumber = async (type) => {
  try {
    const response = await axiosInstance.get(`/productsNumber/${type}`);
...
export const getIdCategorys = async () => {
  try {
    const response = await axiosInstance.get(`/categorysIds`);
    if (response.data.stat !== null) {
      return response.data.arr;
    }
    return null;
