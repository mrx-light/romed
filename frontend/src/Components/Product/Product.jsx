          ...
          result.forEach((el, i) => {
            ...
            product = (
              <>
                ...
                <div className="gray">
                  In Stoc:{" "}
                  <span className="whiteColor fontWeight">{el.inStock ? "da" : "nu"}</span>
                </div>
                <Button
                  style={style}
                  variant="contained"
          ...
          result.forEach((el, i) => {
            ...
            const card = (
              <CardProduct
                ...
                title={el.name}
                buttonHandler={() => { window.open(el.link, "_blank") }}
                link={"Procurati"}
                type={el.type}
                redirectToProduct={() => { window.open(el._id, "_self") }}
                keys={i}
                buttonHandlerCategorys={() => window.open("/categorys/" + el.type, "_self")}
              />
            );
            arr.push(card);
          });
        ...
        <div className={`max displayFlexCategorys ${classes.widthMax}`}>
          ...
          <div className={`${classes.widthMax} ${classes.margin} `}>
            ...
            <div className={`flex ${classes.marginFlex}`}>
              <div className="inlineFlexCategorys">
