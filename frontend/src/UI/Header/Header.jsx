...
function Header(props) {
  ...
  async function goHome() {
    params.push("/home")
    window.scrollTo(0, 0)
    // const result = axiosInstance.get("https://www.instagram.com/gali_2538/")
  }
  function goAboutUs() {
    params.push("/home")
      ...
      <div className='container text-uppercase fw-bold padding'>
        <div className="justifyAlign ">
          ...
          <div className="displayFlex ">
            <div className="pointer padding5 color" onClick={goHome}>Acasă</div>
            <div className="pointer padding5 color" onClick={goAboutUs}>Despre Noi</div>
            <div className="pointer padding5 color" onClick={goNews}>Noutăți</div>
            <div className="pointer padding5 color" onClick={goServices}>Servicii</div>
            <div className="pointer padding5 color" onClick={goProducts}>Produse</div>
            <div className="pointer padding5 color" onClick={goPartners}>Parteneri</div>
            <div className="pointer padding5 color" onClick={goContacts}>Contacte</div>
          </div>
        </div>
      </div>
    </div>
